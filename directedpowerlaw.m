function b=directedpowerlaw(numnode,stnode,stedges,counter)
...
% USAGE
% 
% b=directedpowerlaw(numnode,stnode,stedges,counter);
%
% INPUT ARGUMENTS
